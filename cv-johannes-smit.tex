...
\begin{center}
	...
	{\large
	% Email
	\href{mailto:hannes.smit@live.co.uk}{\nolinkurl{hannes.smit@live.co.uk}}
	% \href{mailto:h@nnessm.it}{\nolinkurl{h@nnessm.it}} 
	\hfill
	% Website
	\href{https://hasnep.netlify.app}{\nolinkurl{hasnep.netlify.app}}
	% \href{https://ha.nnessm.it/}{\nolinkurl{ha.nnessm.it}}
	\hfill
	% GitHub
...
\begin{itemize} 
	...
	Other modules included machine learning and spatial-temporal statistics.
...
\begin{itemize}
	...
	I am learning the programming languages \enquote{Julia} and \enquote{Typescript} as a hobby, some of my projects can be found on my GitHub profile (\href{https://github.com/hasnep/}{\nolinkurl{github.com/hasnep}}).
